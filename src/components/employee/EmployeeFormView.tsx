    ...
    return (
        <div>
            <div className="ems-page-header">
                ...
                <button type="button" className="ems-btn ems-btn-outline" onClick={onCancel}>
                ...
                <div className="ems-form-card">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                        ...
                        <div className="ems-form-actions">
                            <button type="button" className="ems-btn ems-btn-outline" onClick={onCancel}>Cancel</button>
                            <button
                                type="submit"
                                className="ems-btn ems-btn-primary"
                                disabled={isSubmitting}
                                aria-label={isEdit ? "Update Employee" : "Add Employee"}
                            >
                                {isEdit ? (isSubmitting ? "Updating..." : "Update Employee") : (isSubmitting ? "Saving..." : "Save Employee")}
                            </button>
                        </div>
                    </form>
                </div>
